...
<div class="top-bar py-4">
	<div class="col-6-md text-right">
		<p class="txtfont pr-4"><i class="far fa-envelope"></i><a href="" class="links"> pavangujjari@mylivefarming</a></p>
	</div>		
</div>
<!-----------------------------------------------NavBar--------------------------------------------->
...
<div id="myCarousel" class="carousel slide carousel-fade" data-ride="carousel" data-interval="4550">
	...
	<div class="carousel-inner">
		<div class="carousel-item active" style="background-image: url('images/carousel-images/wheat-slide1.jpg');">
			<div class="container carousel-text " >
				<h1 class="font"><span class="light-text">BEST </span><span class="bg px-2 py-2 rounded-right">HARVEST</span></h1>
		...
		<div class="carousel-item" style="background-image: url('images/carousel-images/corn-slide2.jpg');">
			<div class="container carousel-text">
				<h1 class="font"><span class="light-text">SAVE OUR </span><span class="bg px-2 py-2 rounded-right">SOIL</span></h1>
		...
		<div class="carousel-item" style="background-image: url('images/carousel-images/vegetables-slide3.jpg');">
			<div class="container carousel-text">
		...
		<div class="carousel-item" style="background-image: url('images/carousel-images/field-slide4.jpg');">
			<div class="container carousel-text">
				<h1 class="font" ><span class="text-light">Help</span> Farmers</h1>
				<p>Cahhd pavan jdue hsgdhsabx gsh hzgxhghxz hsg bxh am are<br>pkdhfghd bsfdgsas</p>
				<a href="user_signup.php" class="btn btn-outline-success text-dark">Sign up today</a>
			</div>
		</div>
	</div>
		...
		<div class="row">
			...
			<div class="col-lg-6 col-mt-lg">
				<figure class="home-about-img-alt">
					<img class="planting-img w-100" alt="" src="images/planting.jpg">
				</figure>
...
<div class="popup-parallax" style="background-image: url('images/parallax-img.jpg');">
	...
	<div class="row"> 
 		<div class="col-lg-6"> 
			<div class="masonry-left-layer aos-init aos-animate" data-aos="fade-up">
                ...
                <figure class="ml-img">
                	<img class="w-100 rounded"  src="images/vegetables2.jpg" alt="">
                </figure>
             </div>
        </div> 
        <div class="col-lg-6 col-mt-lg">
        	<div class="masonry-right-layer aos-init aos-animate" data-aos="fade-down">
            	<figure class="ml-img">
                	<img class="w-100 rounded" src="images/vegetables1.jpg" alt="">
                </figure>
                <div class="ml-caption">
...
<div class="container my-4"> 
	<div class="border-top border-success w-25 mx-auto my-3"></div>
	<div id="gallery" class="text-center"><h2><span class="light-text">Our</span> Gallery <i id="gallery" class=" pl-3 fas fa-angle-double-down btn btn-outline-dark btn-lg"></i></h2></div>
	<div class="border-top border-success w-25 mx-auto my-3"></div>
</div>
<div id="divgallery" class="row galleryswipe">
<!--Grid column-->
	<div class="col-lg-4 col-md-12 mb-4">
		<img src="images/gallery/corn.jpg" class="img-fluid mb-4 rounded" alt="">
        <img src="images/gallery/farming.jpg" class="img-fluid mb-4 rounded" alt="">
     </div>
     <div class="col-lg-4 col-md-6 mb-4">
        <img src="images/gallery/oranges.jpg" class="img-fluid mb-4 rounded" alt="">
        <img src="images/gallery/planting.jpg" class="img-fluid mb-4 rounded" alt="">
      </div>
      <div class="col-lg-4 col-md-6 mb-4">
        <img src="images/gallery/onion.jpg" class="img-fluid mb-4 rounded" alt="">
        <img src="images/gallery/plants.jpg" class="img-fluid mb-4 rounded" alt="">
      </div>
</div>
...
<div class="border-top border-success w-25 mx-auto my-3"></div>
	<div style="background-image: url('https://wallpapercave.com/wp/wp3708762.jpg'); background-repeat: no-repeat;background-size: cover;" class="w-100 bg-img my-4">
		<form class="container bg py-4 rounded shadow-lg" action="#contactus" method="post">
			...
			<center><button type="submit" class="btn btn-success mb-2" name="submit" id="submit">Send</button></center>
		</form>
	</div>
<!-- Footer Page -->  
		...
		<div class="row">
			...
			<div class="col-md-4 col-sm-4 text-center text-light">
				...
				<ul class="list-unstyled">
					...
					<li class="my-2"><i class="fas fa-envelope bg-dark mr-2"></i><a class="links" href="#">infogathering@pavangujjari.com</a></li>
