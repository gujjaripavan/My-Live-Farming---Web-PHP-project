...
<nav class=" bg navbar navbar-expand-lg navbar-light sticky-top shadow-lg" role="navigation">
	...
	<div class="collapse navbar-collapse justify-content-between" id="navbarResponsive">
		<ul class="navbar-nav mr-auto">
			...
			<li ><a class="nav-link" href="../store/store.php"><i class="fas fa-store"></i> Store</a></li>
		</ul>
...
<div id="myCarousel" class="carousel slide carousel-fade pb-4" data-ride="carousel" data-interval="4550">
	...
	<div class="carousel-inner">
		<div class="carousel-item active" style="background-image: url('../images/user_page/user_fruits.jpg');">
			<div class="container carousel-text pt-4" style="background:linear-gradient(to right, #040404, #000000, #656565);border-radius: 25px;" >
				...
				<a href="user_signup.php" class="btn btn-outline-success text-light">Use Promocode:PAVAN30</a>
			</div>
		</div>
		<div class="carousel-item" style="background-image: url('../images/user_page/oranges.jpg');">
		...
		<div class="carousel-item" style="background-image: url('../images/user_page/agriculture.jpg');">
			<div class="container carousel-text">
		...
		<div class="carousel-item" style="background-image: url('../images/user_page/help_farmers.jpg');">
			<div class="container carousel-text">
...
<div class="container py-4">
    ...
    <div class="card-group shadow-lg pb-4">
      <div class="card">
        <img class="card-img-top rounded img-responsive" src="../images/user_page/orange.jpg" alt="Card image cap">
        <div class="card-body">
      ...
      <div class="card mx-3">
        <img class="card-img-top rounded img-responsive " src="../images/user_page/vegetables.jpg" alt="Card image cap">
        <div class="card-body">
      ...
      <div class="card">
        <img class="card-img-top shadow-lg" src="../images/user_page/help-farmer.jpg" alt="Card image cap">
        <div class="card-body">
