...
<div class="top-bar py-4">
	<div class="col-6-md text-right">
		<p class="txtfont pr-4"><i class="far fa-envelope"></i><a href="" class="top-link"> pavangujjari@mylivefarming</a></p>
	</div>		
</div>


<nav class="navbar navbar-expand-lg navbar-light sticky-top shadow-lg" role="navigation" style="background-color:  #82b440;
	color: black;">
	...
	<div class="collapse navbar-collapse justify-content-between" id="navbarResponsive">
		<ul class="navbar-nav mr-auto">
			...
			<li ><a class="nav-link mx-4active" href="store.php"><i class="fas fa-store"></i> Store</a></li>
		</ul>
