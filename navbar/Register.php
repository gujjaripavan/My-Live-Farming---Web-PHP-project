...
<div class="container text-center shadow-lg pb-3">
	<div class="card-group mb-2">
  		<div class="card mr-3">
    		<img class="card-img-top img-fluid zoom" src="../images/register/user.jpg" alt="Card image cap" style="height: 201px;">
    	<div class="card-body">
      		<h5 class="card-title font text-center bg py-2"><i class="fas fa-users"></i> User Register</h5>
  		...
  		<div class="card mr-3">
    		<img class="card-img-top" src="../images/register/farmer_register.jpg" alt="Card image cap">
    	<div class="card-body">
      		<h5 class="card-title font text-center bg py-2"><i class="fas fa-seedling"></i> Farmer Register</h5>
  		...
  		<div class="card">
    		<img class="card-img-top" src="../images/register/supplier.jpg" alt="Card image cap">
    	<div class="card-body">
      		<h5 class="card-title font text-center bg py-2"><i class="fas fa-truck"></i> Supplier Register</h5>
